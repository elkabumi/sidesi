                            ...
                            <div class="box box-cokelat">
                                ...
                                <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label>Parent</label>
                                            <input required type="text" readonly="readonly" name="i_parnet_name" class="form-control" placeholder="Masukkan nama ..." value="<?= $row->vps_parent_name ?>"/>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Nama</label>
                                            <input required type="text" name="i_name" class="form-control" placeholder="Masukkan nama ..." value="<?= $row->vps_name ?>"/>
                                        </div>
                                       ...
                                       <select id="basic" name="i_child_separator" class="selectpicker show-tick form-control" data-live-search="true">
                                        ...
                                        <option value="." <?php if($row->vps_child_separator == "."){ ?>selected <?php } ?>  >.</option>
                                             <option value=")" <?php if($row->vps_child_separator == ")"){ ?>selected <?php } ?>  >)</option>
